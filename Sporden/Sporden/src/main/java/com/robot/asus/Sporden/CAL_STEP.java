...
import com.robot.asus.common.logger.Log;
import com.robot.asus.common.logger.LogView;
import com.robot.asus.common.logger.LogWrapper;
import com.robot.asus.common.logger.MessageOnlyLogFilter;
 ...
 */
public class CAL_STEP extends AppCompatActivity {
    public static final String TAG = "CAL_STEP";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cal_step);
    ...
    private void initializeLogging() {
        ...
        logView.setTextAppearance(R.style.AppTheme);
