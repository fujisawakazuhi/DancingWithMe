...
public class WorkoutGamingShake extends RobotActivity {
    ...
    private static String WorkoutName, VideoUri;
    ...
    public boolean actionStartChecker() {
        ...
        if (script.get(scriptNum) == 1 && answer[d1].getZ() > 1.2) {

            return true;
        } else if (script.get(scriptNum) == 2 && answer[d1].getZ() < 1.2) {
    ...
    public boolean actionRestartChecker() {
        ...
        if (script.get(scriptNum) == 1 && answer[d1].getZ() > 1.3) {
            ...
            return true;
        } else if (script.get(scriptNum) == 2 && answer[d1].getZ() < 1.1) {
    ...
    public void actionChecker() {
        ...
        if (actionDetecter.getActionResult()) {
            ...
            if (isShake) {
                ...
                effectSound(3);
                robotAPI.robot.speak(getString(R.string.remeber_shake));
                Log.d("ScoresmallGet", totalscore + "");
                actionStarter();
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (isGetCount == 10) {
                    ...
                    Toast toast = Toast.makeText(WorkoutGamingShake.this,
                            getString(R.string.cannot_see), Toast.LENGTH_SHORT);
                    toast.show();
        ...
        handlerC.post(new Runnable() {
            ...
            public void run() {
                if (isPostFalse && isPostEnd) {
                    isPostEnd = false;
                    isPostFalse = false;
                    startActivity(new Intent(WorkoutGamingShake.this, MainActivity.class));
                    System.exit(0);
    ...
    public void TimeCounter() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (timeCountAction % 8 == 0 && !isStarted && isgetFace && !isrestart) {
